...
``` {r stations , eval=F, fig.width=7,fig.height=7, fig.fullwidth=TRUE}
library(climate)
...
# df = meteo_ogimet(interval = "hourly", date = c("2016-01-01", "2016-12-31"), station = c("01008"))
```
...
```{r sonda2, echo=FALSE}
library(knitr)
kable(head(df2, 10), caption = "Exemplary data frame of sounding preprocessing")
```
...
library(knitr)
kable(head(h2), caption = "Exemplary data frame of hydrological preprocesssing.")
```
