...
test_that("meteo_ogimet works!", {
  ...
  df = tryCatch(meteo_ogimet(interval = "daily", date = c("2019-06-01", "2019-06-08"),
  ...
  x = tryCatch(meteo_ogimet(interval = "hourly", date = c("2019-06-01", "2019-06-08"),
  ...
  x = tryCatch(meteo_ogimet(interval = "hourly", date = c("2019-01-01", "2019-01-05"),
               station = 12001, coords = FALSE), error = function(e) 0)
  ...
  petrobaltic = tryCatch(ogimet_hourly(station = 12001,
                         date = c(as.Date("2019-01-01"), as.Date("2019-01-05")),
                         coords = TRUE, precip_split = TRUE), error = function(e) 0)
