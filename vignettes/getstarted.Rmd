...
>>>>>>> 6cc42c2b65fa0fd2cf4550809fa8922f32a1afb5
...
library(knitr)
kable(head(df[,c(1:12)],10), caption = "Examplary data frame of meteorological data.")
```
...
```{r imgw_meteo,eval=T, fig.width=7, fig.height=7, fig.fullwidth=TRUE}
=======
### Example 4
